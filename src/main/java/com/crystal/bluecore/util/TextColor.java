...
public class TextColor {
    private static final Formatting[] colour = new Formatting[] {
            Formatting.RED, Formatting.GOLD, Formatting.YELLOW, Formatting.GREEN, Formatting.AQUA,
            Formatting.BLUE, Formatting.LIGHT_PURPLE, Formatting.DARK_GREEN, Formatting.DARK_PURPLE, Formatting.DARK_RED
    };
