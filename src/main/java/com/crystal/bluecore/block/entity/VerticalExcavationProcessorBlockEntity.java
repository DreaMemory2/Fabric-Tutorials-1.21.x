...
public class VerticalExcavationProcessorBlockEntity extends BlockEntity implements TickableBlockEntity {
    ...
    private int ticks = 0;
    // 挖掘方块的位置（始终在该方块以下的位置）
    private BlockPos miningPos = pos.down();
    ...
    protected void writeNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registryLookup) {
        ...
        nbt.putLong("MiningPos", miningPos.asLong());
    }
    ...
    protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registryLookup) {
        ...
        miningPos = BlockPos.fromLong(nbt.getLong("MiningPos"));
    }
    ...
    public void tick() {
        ...
        if(ticks++ % 20 == 0) {
            ...
            if(miningPos.getY() <= world.getBottomY()) miningPos = pos.down();
            // 获取方块状态
            ...
            Storage<ItemVariant> aboveStorage = findItemStorage((ServerWorld) world, pos.up());
            // 判断存储空间是否支持存储物品
